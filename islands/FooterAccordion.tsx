...
export const sections = [
  {
    ...
    content: (
      <div class="flex flex-col">
        <a
          href="https://secure.offpremium.com.br/api/io/login?returnUrl=https://deco-fashion.deco.page"
  ...
  },
  {
    ...
    content: (
      <div class="flex flex-col p-4">
        <span class="text-white mb-4 text-white text-xs">Pagamento por Pix</span>
