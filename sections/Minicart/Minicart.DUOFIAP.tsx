    ...
    return (
        <div class="flex flex-col my-4 px-4">
            <div class="flex justify-center items-center h-36 w-auto border-dashed border-2 border-gray-400">
                <p class="text-xl font-albert-sans text-gray-900">{props.placeholder}</p>
            </div>
        </div>
    )
}
...
export default function CartSideBar({quantityHeader = 2, priceRemains = 361.55, value = 459.55}: Props) {
        ...
        <div class="max-w-[400] sm:max-w-[360px] lg:max-w-[400]">
            <div class="flex flex-col justify-center h-full w-full]">
                ...
                <div class="flex flex-row gap-2 p-4 items-center">
                    <img src="https://i.imgur.com/jeyINVe.png" alt="Minha imagem" class="w-5 h-6" />
                    <h2 class="font-albert-sans text-2xl text-gray-900">Your Cart</h2>
                    <button class="h-7 w-7 bg-blue-100 rounded-2xl">
                        <p class="font-albert-sans text-lg text-blue-500">{quantityHeader}</p>
                    </button>
                </div>
                ...
                <div class="flex flex-col p-4">
                    <div class="flex flex-row gap-2 items-center">
                        <img src="https://i.imgur.com/VoES1Cu.png" alt="Minha imagem" class="w-5 h-3.8" />
                        <p class="text-sm text-green-800">Faltam R$ {priceRemains.toFixed(2)} para ganhar frete gratis.</p>
                    </div>
            ...
            <div class="flex flex-col gap-1.5 p-4">
                <div class="flex justify-between w-auto my-1">
                    ...
                    <p class="text-sm font-albert-sans text-gray-900">{value.toFixed(2)}</p>
                </div>

                <div class="flex justify-between w-auto my-1">
                    <p class="text-sm font-albert-sans text-gray-900">Cupom de Desconto</p>
                    <p class="text-sm font-albert-sans text-gray-900">Adicionar</p>
                </div>

                <div class="flex justify-between w-auto my-1">
                    <p class="text-sm font-albert-sans text-gray-900">Codigo do Vendedor</p>
                    <p class="text-sm font-albert-sans text-gray-900">Adicionar</p>
                </div>
            </div>
            ...
            <div class="flex flex-col justify-center w-[100%] px-3">
                ...
                { /* Buttoes Buy */}
                <button class="flex justify-center items-center bg-gray-800 w-full h-7 my-2" onClick={dev}>
                    <p class="text-base font-albert-sans text-white">Fechar Pedido</p>
                </button>

                <button class="flex justify-center items-center border-2 border-gray-400 w-full h-7 my-2" onClick={dev}>
                    <p class="text-base font-albert-sans text-gray-500">Continuar comprando</p>
                </button>
                { /* Buttoes Buy End */}
