...
export default function Newsletter({ title }: NewsletterProps) {
  return (
    <div className="w-full h-screen bg-zinc-100 p-4 flex justify-center items-center">
      <div className="w-96 lg:w-full bg-[#6D8B61] flex flex-col gap-10 p-4 lg:py-16 lg:justify-center items-center">
        <header>
