  ...
  return (
    <>
      <div class="container px-4 py-4 rounded border border-base-200 flex flex-col sm:flex-row gap-4 items-start sm:items-center shadow bg-base-100">
        ...
        <button
          class="ml-auto self-end bg-slate-700 rounded-none border-none font-default"
          style="height: 40px; width: 80px;"
        >
          <text class="text-white normal-case font-light">{buttonText}</text>
        </button>

        <button class="fixed top-5 right-12 order-last self-end btn-outline flex items-start btn-outline rounded-none border-none justify-end align-top w-main p-0 m-0 h-min">
          <Icon
