...
export default function FAQ(props:Props) {
    const {
        subtitleTop = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.",
        subtitlebot = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. ",
        botao = "Contact",
        questions= [{ question: "Pergunta de exemplo", answer: "Resposta de exemplo"}]
      } = props;
  return (
    <div class="container-faq max-w-screen-md  m-auto pt-200px max-[700px]:mx-4">
      ...
      <div class="middle my-16">
        {props.questions.map(({ question, answer }) => (
          <div
            tabIndex={0}
            class="collapse collapse-arrow border-t border-base-300 bg-base-100 py-2"
          >
            <input type="checkbox" />
