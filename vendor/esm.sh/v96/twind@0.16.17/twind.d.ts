import { PropertiesFallback, PropertiesHyphenFallback, AtRule, SimplePseudos } from 'https://esm.sh/v96/csstype@3.1.1/index.d.ts';
...
declare type MaybeObjInterpolationGeneric<T> = T[] | [TemplateStringsArray, ...T[]];
