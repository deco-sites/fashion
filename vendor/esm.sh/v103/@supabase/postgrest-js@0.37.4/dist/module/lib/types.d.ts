...
export declare type PostgrestResponse<T> =
...
export declare type PostgrestSingleResponse<T> =
  | PostgrestSingleResponseSuccess<T>
  | PostgrestResponseFailure;
export declare type PostgrestMaybeSingleResponse<T> = PostgrestSingleResponse<
  T | null
>;
export declare abstract class PostgrestBuilder<T>
