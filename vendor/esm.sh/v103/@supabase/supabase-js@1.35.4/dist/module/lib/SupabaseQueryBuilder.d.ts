...
import { Fetch, GenericObject, SupabaseEventTypes, SupabaseRealtimePayload } from './types.d.ts';
export declare class SupabaseQueryBuilder<T> extends PostgrestQueryBuilder<T> {
    ...
    private _schema;
    private _table;
    constructor(url: string, { headers, schema, realtime, table, fetch, shouldThrowOnError, }: {
