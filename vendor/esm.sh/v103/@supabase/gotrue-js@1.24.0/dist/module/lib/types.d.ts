export declare type Provider =
  ...
  | "twitter"
  | "workos";
export declare type AuthChangeEvent =
  | "PASSWORD_RECOVERY"
  | "SIGNED_IN"
  | "SIGNED_OUT"
  | "TOKEN_REFRESHED"
...
export declare type VerifyOTPParams =
...
export declare type EmailOTPType =
  | "signup"
  | "invite"
  | "magiclink"
  | "recovery"
...
export declare type SupportedStorage = PromisifyMethods<
