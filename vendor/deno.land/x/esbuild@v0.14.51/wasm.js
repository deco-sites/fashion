...
function readUInt32LE(buffer, offset) {
  return buffer[offset++] | buffer[offset++] << 8 | buffer[offset++] << 16 |
    buffer[offset++] << 24;
}
...
var mustBeBooleanOrObject = (value) =>
  ...
  let handleIncomingPacket = (bytes) => {
    if (isFirstPacket) {
      ...
      if (binaryVersion !== "0.14.51") {
        throw new Error(
          `Cannot start service: Host version "${"0.14.51"}" does not match binary version ${
    ...
    const callback = async (request) => {
      switch (request.command) {
        case "on-start": {
          ...
          await Promise.all(
            onStartCallbacks.map(
              async ({ name, callback: callback2, note }) => {
                try {
                  ...
                  if (result != null) {
                    ...
                    checkForInvalidFlags(
                      result,
                      keys,
                      `from onStart() callback in plugin ${
                        JSON.stringify(name)
                      }`,
                    );
                    if (errors != null) {
...
var analyzeMetafile = (metafile, options) =>
  ensureServiceIsRunning().then((service) =>
...
var startRunningService = async (wasmURL, wasmModule, useWorker) => {
  ...
  if (useWorker) {
    ...
    let onmessage = ((postMessage) => {
      ...
      // Use of this source code is governed by a BSD-style
      // license that can be found in the LICENSE file.
      let onmessage, globalThis = {};
      for (let r = self; r; r = Object.getPrototypeOf(r)) {
        for (let f of Object.getOwnPropertyNames(r)) {
          f in globalThis || Object.defineProperty(globalThis, f, {
            get: () => self[f],
          });
        }
      }
...
`);
              return i != -1 &&
                (console.log(c.substr(0, i)), c = c.substr(i + 1)),
                s.length;
            },
            write(n, s, i, a, h, u) {
        ...
        globalThis.Go = class {
          constructor() {
            ...
            const c = (e, t) => {
              ...
              n = (e) => {
                const t = this.mem.getUint32(e + 0, !0),
                  o = this.mem.getInt32(e + 4, !0);
              ...
              i = (e, t) => {
                if (typeof t == "number" && t !== 0) {
                  if (isNaN(t)) {
                    this.mem.setUint32(e + 4, 2146959360, !0),
                      this.mem.setUint32(e, 0, !0);
                    return;
                  }
                ...
                l === void 0 &&
                (l = this._idPool.pop(),
                  l === void 0 && (l = this._values.length),
                  this._values[l] = t,
                  this._goRefCounts[l] = 0,
                  this._ids.set(t, l)), this._goRefCounts[l]++;
                let m = 0;
                switch (typeof t) {
                  case "object":
                    t !== null && (m = 1);
                ...
                this.mem.setUint32(e + 4, 2146959360 | m, !0),
                  this.mem.setUint32(e, l, !0);
              },
              a = (e) => {
              ...
              u = (e) => {
                const t = n(e + 0), o = n(e + 8);
                return g.decode(
                  new DataView(this._inst.exports.mem.buffer, t, o),
                );
              },
            ...
            this.importObject = {
              go: {
                ...
                "runtime.wasmWrite": (e) => {
                  ...
                  const t = n(e + 8),
                    o = n(e + 16),
                    l = this.mem.getInt32(e + 24, !0);
                  globalThis.fs.writeSync(
                    t,
                    new Uint8Array(this._inst.exports.mem.buffer, o, l),
                  );
                },
                ...
                "runtime.walltime": (e) => {
                  ...
                  c(e + 8, t / 1e3),
                    this.mem.setInt32(e + 16, t % 1e3 * 1e6, !0);
                },
                ...
                "syscall/js.valueCall": (e) => {
                  ...
                  try {
                    const t = s(e + 8),
                      o = Reflect.get(t, u(e + 16)),
                      l = h(e + 32),
                      m = Reflect.apply(o, t, l);
          ...
          async run(c) {
            ...
            this._inst = c,
              ...
              this._ids = new Map([[0, 1], [null, 2], [!0, 3], [!1, 4], [
                globalThis,
                5,
              ], [this, 6]]),
              this._idPool = [],
            ...
            const s = (e) => {
                ...
                return new Uint8Array(this.mem.buffer, n, o.length).set(o),
                  n += o.length,
                  n % 8 !== 0 && (n += 8 - n % 8),
                  t;
              },
            ...
            const u = n;
            a.forEach((e) => {
              this.mem.setUint32(n, e, !0),
                this.mem.setUint32(n + 4, 0, !0),
                n += 8;
            });
            const d = 4096 + 8192;
            if (n >= d) {
        ...
        onmessage = ({ data: r }) => {
          let f = new TextDecoder(), g = globalThis.fs, c = "";
          g.writeSync = (h, u) => {
...
`),
          ...
          onmessage = ({ data: h }) => {
            ...
            g.read = (h, u, d, e, t, o) => {
              ...
              u.set(l.subarray(i, i + m), d),
                i += m,
                i === l.length && (n.shift(), i = 0),
                o(null, m);
            };
          let a = new globalThis.Go();
          a.argv = ["", "--service=0.14.51"],
            r instanceof WebAssembly.Module
              ? WebAssembly.instantiate(r, a.importObject).then((h) => a.run(h))
              : WebAssembly.instantiate(r, a.importObject).then((
                { instance: h },
              ) => a.run(h));
        },
        (r) => onmessage(r);
