...
const variants = {
  ...
  icon:
    "h-[36px] px-2 bg-transparent rounded-full text-default border-transparent active:bg-interactive active:text-default-inverse disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none",
};
