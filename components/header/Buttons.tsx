...
function SearchButton() {
  ...
  return (
    <>
      ...
      >
        <Icon id="MagnifyingGlass" width={20} height={20} strokeWidth={2} />
      </Button>
    </>
  );
}
...
function CartButton() {
  ...
  return (
    ...
    >
      ...
      {totalItems && (
        <span class="absolute text-sm right-0 top-0 rounded-full bg-badge text-white w-4 h-4 flex items-center justify-center">
          {totalItems}
        </span>
      )}
    </Button>
