  ...
  return (
    ...
    >
      ...
      <div class="h-full z-10">
        ...
        <div class="absolute hidden group-hover:md:block group-hover:md:border border-black bottom-0 inset-x-0 z-10 opacity-0 group-hover:md:opacity-100 bg-white group-hover:md:translate-y-full transition ease-in duration-300">
