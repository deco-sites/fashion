...
export default function CampaignTimer() {
  ...
  return (
    <div className="flex flex-col py-2 px-4 h-auto w-auto gap-4 text-black bg-green-200 items-center justify-center lg:flex-row font-sans lg:justify-center lg:items-center lg:py-4 lg:px-16 lg:h-76 lg:gap-16 lg:max-w-full text-white bg-accent-standard">
      <span className="font-normal text-sm-standard">
        Time left for a campaign to end wth a <a>link</a>
      </span>
      <div className="flex flex-row">
        <div className="flex items-center text-center font-normal text-sm text-white leading-7 ">
          <div className="flex flex-row gap-6">
            <div className="flex flex-col items-center justify-center gap-1">
              ...
              <span className="font-normal font-sans text-xs items-center">
                Hours
              </span>
            </div>
        ...
        <button className="btn rounded-none gap-2 h-10 w-[4.625rem] px-2 py-3 text-base bg-button-timer ml-6">
          <span className="top-2 left-3 items-center text-base font-normal normal-case">
            Button
          </span>
        </button>
      </div>
