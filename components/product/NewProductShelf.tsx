...
import SliderJS from "$store/islands/NewSliderJS.tsx";
import Icon from "$store/components/ui/Icon.tsx";
import Slider from "$store/components/ui/new-slider/Slider.tsx";
import type { ItemsPerPage } from "$store/components/ui/new-slider/Slider.tsx";
