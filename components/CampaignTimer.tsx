...
export default function Navbar(params: Props) {
  return (
    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center gap-2 lg:gap-16 bg-red-300 p-4">
      <p className="lg:text-xl text-center text-white text-sm">Time left for a campaign to end with a <a href="#" className="font-medium underline hover:no-underline">link</a></p>
